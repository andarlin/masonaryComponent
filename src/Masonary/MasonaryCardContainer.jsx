...
import Cards from "./MasonaryCard";
import "./style.css";
...
class MasonaryCard extends Component {
  render() {
    return (
      <div className="container">
        ...
        <Cards
          box="box"
          img={jonathan}
          personsName="Jonathan Walters"
          title="The team was very supportive and kept me motivatedd"
